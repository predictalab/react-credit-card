...
var Card = function (_a) {
    ...
    var renderCardLogo = function (type) {
        if (type === "amex") {
            return jsx(SiAmericanexpress, {});
        }
        else if (type === "mastercard") {
            return jsx(RiMastercardLine, {});
        }
        else if (type === "discover") {
            return jsx(FaCcDiscover, {});
        }
        else {
            return jsx(RiVisaLine, {});
        }
    };
    // Format months to display it as "01" is value is "1"
    var formatMonthDisplayed = function (month) {
    ...
    return (jsx("div", { children: jsx("div", { className: styles$1.container, children: jsxs("div", { "data-flipped": creditCard.flipped, className: styles$1.inner, children: [jsxs("div", { className: styles$1.front, children: [jsx("div", { className: styles$1.overlay, style: {
                                    background: "linear-gradient(25deg, ".concat(gradientStart, ", ").concat(gradientEnd, ")"),
                                } }), jsxs("div", { className: styles$1.content, children: [jsx("div", { className: styles$1.chip }), jsx("div", { className: styles$1.type, children: renderCardLogo(creditCard.type) }), jsx("div", { className: styles$1.number, onClick: function () { return setFocus(refs.numberInput); }, children: displayNumber.map(function (digit, index) { return (jsxs("div", { className: styles$1.digitWrapper, children: [jsx("div", { className: [
                                                        styles$1.digit,
                                                        digit === "#" ? styles$1.shown : styles$1.hidden,
                                                    ].join(" "), children: "#" }), jsx("div", { className: [
                                                        styles$1.digit,
                                                        digit !== "#" ? styles$1.shown : styles$1.hidden,
                                                    ].join(" "), children: digit !== "#" && digit })] }, index)); }) }), jsxs("div", { className: styles$1.name, onClick: function () { return setFocus(refs.nameInput); }, children: [jsx("label", { htmlFor: "name", children: texts["Card holder"] }), jsxs("div", { id: "name", children: [jsx("div", { className: [
                                                            styles$1.placeholder,
                                                            creditCard.name.length > 0 ? styles$1.hidden : styles$1.shown,
                                                        ].join(" "), children: texts["FULL NAME"] }), jsx("div", { className: styles$1.nameContainer, children: creditCard.name.split("").map(function (char, index) { return (jsx("div", { className: [
                                                                styles$1.character,
                                                                /\s/.test(char) && styles$1.space,
                                                            ].join(" "), children: char }, index)); }) })] })] }), jsxs("div", { className: styles$1.expiration, children: [jsx("label", { htmlFor: "expiration", children: texts["Expires"] }), jsxs("div", { id: "expiration", className: styles$1.expValues, children: [jsx("div", { onClick: function () { return setFocus(refs.monthInput); }, children: !creditCard.month ? (texts["MM"]) : (jsx("div", { className: styles$1.animated, children: formatMonthDisplayed(creditCard.month) })) }), jsx("div", { children: "/" }), jsx("div", { onClick: function () { return setFocus(refs.yearInput); }, children: !creditCard.year ? (texts["YY"]) : (jsx("div", { className: styles$1.animated, children: "".concat(creditCard.year).slice(-2) })) })] })] })] })] }), jsxs("div", { className: styles$1.back, children: [jsx("div", { className: styles$1.overlay, style: {
                                    background: "linear-gradient(25deg, ".concat(gradientStart, ", ").concat(gradientEnd, ")"),
                                } }), jsxs("div", { className: styles$1.content, children: [jsx("div", { className: styles$1.strip }), jsxs("div", { className: styles$1.cvv, children: [jsx("small", { children: "CVV" }), " ", jsx("br", {}), creditCard.cvv] }), jsx("div", { className: styles$1.type, children: renderCardLogo(creditCard.type) })] })] })] }) }) }));
};
...
var CreditCard = function (_a) {
    ...
    var _b = useState(creditCardValues), creditCard = _b[0], setCreditCard = _b[1];
    var texts = translations !== null && translations !== void 0 ? translations : defaultTexts;
    // Refs
    var nameInput = useRef();
    var numberInput = useRef();
    var monthInput = useRef();
    var yearInput = useRef();
    return (jsxs("div", { className: styles.paymentWrapper, children: [jsx(Card, { texts: texts, gradientStart: gradientStartColor, gradientEnd: gradientEndColor, creditCard: creditCard, refs: { nameInput: nameInput, numberInput: numberInput, monthInput: monthInput, yearInput: yearInput } }), jsx(Form, { texts: texts, buttonColor: buttonColor, buttonTextColor: buttonTextColor, submitAction: submitAction, creditCardValues: { creditCard: creditCard, setCreditCard: setCreditCard }, refs: { nameInput: nameInput, numberInput: numberInput, monthInput: monthInput, yearInput: yearInput } })] }));
};
